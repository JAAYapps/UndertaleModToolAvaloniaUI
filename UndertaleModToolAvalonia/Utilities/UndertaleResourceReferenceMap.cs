...
{
    public class UndertaleResourceReferenceMap
    {
        private readonly static Dictionary<Type, TypesForVersion[]> typeMap = new()
        {
            {
        ...
        private readonly static Dictionary<Type, string> referenceableTypes = new()
        {
            { typeof(UndertaleSprite), "Sprites" },
            { typeof(UndertaleBackground), "Backgrounds" },
        ...
        public readonly static HashSet<Type> CodeTypes = new()
        {
            typeof(UndertaleCode),
