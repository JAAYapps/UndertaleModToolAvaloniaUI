...
#pragma warning disable CA1416
    public class UndertaleCachedImageLoaderold : IValueConverter
    {
        ...
        private static readonly EditorView mainWindow = (EditorView)(Application.Current.ApplicationLifetime as IClassicDesktopStyleApplicationLifetime).MainWindow;
    ...
    {
        private static UndertaleCachedImageLoaderold loader = new();
    ...
    public class CachedTileDataLoader : IMultiValueConverter
    {
        ...
        public object? Convert(IList<object?> values, Type targetType, object? parameter, CultureInfo culture)
        {
            ...
            try
            {
                ...
                {
                    tilePageBMP = UndertaleCachedImageLoaderold.CreateSpriteBitmap(new(tilesBG.Texture.SourceX,
        ...
        public ImageSource CreateLayerSource(in Layer.LayerTilesData tilesData, in UndertaleBackground tilesBG, in int w, in int h)
        {
            ...
            nint bmpPtr = layerBMP.GetHbitmap();
            ImageSource spriteSrc = System.Windows.Interop.Imaging.CreateBitmapSourceFromHBitmap(bmpPtr, nint.Zero, Int32Rect.Empty, BitmapSizeOptions.FromEmptyOptions());
            layerBMP.Dispose();
